...
public class LayoutServiceTests
{
    ...
    public async Task UpdateSlotAsync_UpdatesDbAndBroadcasts()
    {
        ...
        var options = new DbContextOptionsBuilder<PPSNR.Server2.Data.ApplicationDbContext>()
            .UseSqlite(connection)
            .Options;

        // Create schema
        using (var ctx = new PPSNR.Server2.Data.ApplicationDbContext(options))
        {
        ...
        using (var ctx = new PPSNR.Server2.Data.ApplicationDbContext(options))
        {
            var service = new PPSNR.Server2.Services.LayoutService(ctx, mockHub.Object);
        ...
        await using (var ctx = new PPSNR.Server2.Data.ApplicationDbContext(options))
        {
