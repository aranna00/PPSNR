...
internal sealed class IdentityRedirectManager(NavigationManager navigationManager)
{
    ...
    public void RedirectToInvalidUser(UserManager<ApplicationUser> userManager, HttpContext context) => RedirectToWithStatus
        ("Account/InvalidUser", $"Error: Unable to load user with ID '{userManager.GetUserId(context.User)}'.", context);
}